Feature: Web table user order feature
  ...
  @wip #Scenario Outline and Scenario Template the same, always come with Examples as below
  Scenario Outline: User should be able to place order and order seen in web table
    ...
    Examples: Famous female scientists
      ...
      | MoneyCog    | 2        | invalid name       | London st | London | England | 50505   | Visa     | 1212121212112    | 12/24   | Marie Curie        |
      | Familybea   | 3        | Rosalind Franklin  | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Rosalind Franklin  |
      | Screenable  | 4        | Lasdas             | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | List Meitner       |
